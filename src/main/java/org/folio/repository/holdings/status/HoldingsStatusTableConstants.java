...
public class HoldingsStatusTableConstants {
  ...
  public static final String UPDATE_IMPORTED_COUNT = "UPDATE %s SET " + JSONB_COLUMN + " = jsonb_set(" + JSONB_COLUMN + ", '{data,attributes,importedCount}', ((" + JSONB_COLUMN + "->'data'->'attributes'->>'importedCount')::int + %s)::text::jsonb, false)";
